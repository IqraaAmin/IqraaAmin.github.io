---
title: "My Overall Learning Journey: From Basics to AI and Data Science"
date: 2026-05-19
...
My first semester was about building foundations. I learned Programming Fundamentals, which introduced me to the logic and syntax of coding. I also had my first encounter with Machine Learning — an experience that was both challenging and inspiring. Working on an ML project in the very first semester pushed me to learn Python libraries like NumPy, Matplotlib, and Scikit-learn much faster than I would have otherwise.
...
The second semester deepened and expanded everything I had started in the first. Database Systems introduced me to the world of structured data management — designing schemas, writing SQL queries, and understanding normalization. These skills complemented my machine learning knowledge perfectly because data management is the foundation of every AI system.

I also went deeper into Python and data science in the second semester. Learning advanced Pandas techniques — GroupBy operations, merging DataFrames, and systematic data cleaning — made me much more capable of working with real-world data. I completed two database projects and two OOP projects, each of which required me to think carefully about design and implementation. I also worked on a Digital Logic Design project that gave me insight into the hardware side of computer engineering.

By the end of the second semester, I had a much more complete picture of what computer engineering involves. It is not just about coding — it is about systems thinking, data management, hardware understanding, and problem-solving across multiple domains. Each subject I studied contributed a different piece to this bigger picture.
